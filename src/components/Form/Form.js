                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className={styles.formContainer1}>
                            <section className={styles.titleOrganize}>
                                ...
                                {(meme.logo && meme.name) ? 
                                <button type="button" className={styles.textButton} onClick={() => changeToStep2()}>Avançar</button> :
                            ...
                            <section className={styles.formInputs}>     
                                {meme.logo ? <img className={styles.logo} src={meme.logo} alt="" onError={imageAlert}/> : null}
                                <label htmlFor="logo">Foto do perfil <span style={{fontSize:"12px"}}>*</span></label>
                                <input id="logo" name="logo" value={meme.logo} onChange={handleChange}                                              
                        ...
                        <div className={styles.formContainer2}>
                            <section className={styles.titleOrganize}>
                                ...
                                <button type="button" className={styles.arrowButton} onClick={() => changeToStep2()}><HiOutlineArrowLeft size={30}/></button>
                                ...
                                <button type="submit" className={styles.textButton} >Compartilhar</button>:
                            ...
                            <section className={styles.step3}>
                                ...
                                <section className={styles.formInputs2}>   
                                    ...
                                    <input id="local" name="local" value={meme.local} onChange={handleChange} placeholder="Ex: São Paulo, Brasil" />
